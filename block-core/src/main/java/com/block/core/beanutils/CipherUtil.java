...
public class CipherUtil {
	...
	public static void main(String[] args) throws Exception {
		String plain = "root@123";//gkndo6rXYeOzhkeEUHpDhA==
		System.out.println(encryptIWAP(plain));
		
		System.out.println(CipherUtil.decryptIWAP("Zov3N0m+sU/h37IlicFjiHWa4yRUnFlh1"));
//		String p=encodePassword("123456","admin");
